  ...
  return (
    <div className="flex justify-center items-center min-h-screen w-full relative px-4 sm:px-6 lg:px-8 bg-background">
      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-[80%] py-12 lg:py-0">
        ...
        {/* Subheadline */}
        <p className="text-center text-sm sm:text-base lg:text-xl font-thin text-light/60 mb-3 px-4 sm:px-0">
          We transform your ideas into digital wonders of{" "}
          <span className="italic font-extralight text-light">
            stunning quality
          </span>
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row justify-center items-center w-full space-y-4 sm:space-y-0 sm:space-x-8 mt-6 sm:mt-0">
          {/* Btn - 1 */}
          <button className="border-primary border bg-primary/20 px-4 sm:px-5 py-1 rounded-full flex justify-center items-center relative text-sm sm:text-md">
            Explore
            <span className="ml-2 rounded-full bg-primary h-full w-full p-[18px] sm:p-[22px] flex justify-center items-center translate-x-4">
              {/* Arrow Icon */}
              <svg
                width="20"
                height="14"
                ...
                className="absolute scale-75 sm:scale-90"
              >
                <path
          ...
          {/* Btn - 2 */}
          <button className="border-light border bg-dark px-4 sm:px-5 py-2 sm:py-3 rounded-full flex justify-center items-center relative text-sm sm:text-md">
            Contact Now
          </button>
        </div>
      </div>
      ...
      <div>
        {/* Left Content */}
        <span className="hidden sm:block text-light text-[8px] sm:text-[10px] font-thin uppercase tracking-[6px] sm:tracking-[8px] absolute top-1/2 -translate-y-1/2 -left-6 -rotate-90">
          Creative
        </span>
        <div className="hidden sm:flex absolute top-[80%] -translate-y-1/2 left-4 sm:left-10 flex-col gap-2">
          <div className="absolute top-0 -left-3 w-[1px] h-full bg-light"></div>
          <div className="absolute top-full -left-3 w-[6px] h-[6px] -translate-y-1/2 -translate-x-1/2 bg-light rounded-full"></div>
          <span className="font-semibold text-secondary text-xl sm:text-2xl">
            Creative
          </span>
          <span className="font-semibold text-xl sm:text-2xl">Experience</span>
          <span className="font-semibold text-secondary text-xl sm:text-2xl">
            Unordinary
          </span>
        </div>
        ...
        {/* Right Content */}
        <span className="hidden sm:block text-light text-[8px] sm:text-[10px] font-thin uppercase tracking-[6px] sm:tracking-[8px] absolute top-1/2 -translate-y-1/2 -right-6 rotate-90">
          Agency
        </span>
        <div className="absolute top-[90%] -translate-y-1/2 right-4 flex flex-col items-end gap-4">
          <span className="font-silkserif text-sm sm:text-md">#2025</span>
        </div>
        <Video />

        {/* Center Content */}
        <span className="absolute bottom-4 sm:bottom-0 -translate-y-1/2 left-1/2 -translate-x-1/2">
          {/* Scroll Icon */}
          <svg
            width="20"
            height="20"
